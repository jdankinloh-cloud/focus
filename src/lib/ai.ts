...
Важно: НЕ спрашивай подтверждение перед созданием задачи — просто создавай, система сама спросит пользователя. Отвечай текстом + JSON блок создания задачи в одном сообщении.
